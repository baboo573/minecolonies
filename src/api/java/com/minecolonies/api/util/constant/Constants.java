...
public class Constants
{
    ...
    public static final int    BARBARIAN_HORDE_DIFFICULTY_MIN   = 1;
    public static final int    BARBARIAN_HORDE_DIFFICULTY_MAX   = 10;
    public static final int    AVERAGE_NIGHTS_BETWEEN_RAIDS_MIN = 1;
    public static final int    AVERAGE_NIGHTS_BETWEEN_RAIDS_MAX = 10;
