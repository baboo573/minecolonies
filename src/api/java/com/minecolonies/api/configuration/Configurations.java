...
{
    private static final int CITIZEN_RESPAWN_INTERVAL_MIN     = 10;
    private static final int CITIZEN_RESPAWN_INTERVAL_MAX     = 600;
    private static final int BARBARIAN_HORDE_DIFFICULTY_MIN   = 1;
    private static final int BARBARIAN_HORDE_DIFFICULTY_MAX   = 10;
    private static final int BARBARIAN_HORDE_SIZE_MAX         = 20;
    private static final int BARBARIAN_HORDE_SIZE_MIN         = 60;
    private static final int AVERAGE_NIGHTS_BETWEEN_RAIDS_MIN = 1;
    private static final int AVERAGE_NIGHTS_BETWEEN_RAIDS_MAX = 10;
    ...
    public static class Gameplay
    {
        ...
        @Config.RangeInt(min = BARBARIAN_HORDE_DIFFICULTY_MIN, max = BARBARIAN_HORDE_DIFFICULTY_MAX)
        @Config.Comment("What Difficulty should the barbarians hordes be at?")
        public static int barbarianHordeDifficulty = 5;

        @Config.RangeInt(min = BARBARIAN_HORDE_SIZE_MIN, max = BARBARIAN_HORDE_SIZE_MAX)
        @Config.Comment("The maximum size that a barbarian horde should be.")
        public static int maxBarbarianHordeSize = 40;

        @Config.Comment("Whether or not barbarian spawning is enabled?")
        public static boolean doBarbariansSpawn = true;

        @Config.RangeInt(min = AVERAGE_NIGHTS_BETWEEN_RAIDS_MIN, max = AVERAGE_NIGHTS_BETWEEN_RAIDS_MAX)
        @Config.Comment("How many nights (average) between each raid?")
